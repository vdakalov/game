...
(function() {
  controller("main:el,Symbols,ControlSymbol,CharacterGenerator,MT16S2H2FLA", function(el, Symbols, ControlSymbol, CharacterGenerator, MT16S2H2FLA) {
...
(function() {
  service("CharacterGenerator:LiquidCrystal,Symbols,utils", function(LiquidCrystal, Symbols, utils) {
    ...
    return CharacterGenerator = (function() {
      ...
      CharacterGenerator.prototype.CONTROL_SYMBOL_RESET = "resetCursor";

      CharacterGenerator.prototype.CONTROL_SYMBOL_NEWLINE = "newLine";

      CharacterGenerator.prototype.CONTROL_SYMBOL_INCREMENT = "increment";
      ...
      CharacterGenerator.prototype.printSymbol = function(symbol) {
        switch (symbol.constructor.name) {
          case Symbols.ControlSymbol.name:
