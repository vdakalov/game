...
(function() {
  ...
  controller("editor:el,Display,HexSymbol,MT16S2H2FLA,CloseRenderPreprocessor", function(el, Display, HexSymbol, MT16S2H2FLA, CloseRenderPreprocessor) {
    var display;
    ...
    return display.printSymbol(new HexSymbol("B", 5, "f463e8c63e"));
  });

}).call(this);
(function() {
  controller("main:el,HexSymbol,CharacterGenerator,MT16S2H2FLA,CloseRenderPreprocessor", function(el, HexSymbol, CharacterGenerator, MT16S2H2FLA, CloseRenderPreprocessor) {
    var cg, lc, mountPoint, symbols;
    symbols = {
    ...
    return cg.printSymbol(symbols.A);
  });
...
(function() {
  service("MT16S2H2FLA:LiquidCrystal,MT16S2H2FLA_PIXEL", function(LiquidCrystal, MT16S2H2FLA_PIXEL) {
    ...
    return MT16S2H2FLA = (function() {
      ...
      MT16S2H2FLA.prototype.blockSize = {
        width: 5,
        height: 8
      };
...
(function() {
  service("CharacterGenerator:LiquidCrystal,Symbol,utils", function(LiquidCrystal, Symbol, utils) {
    ...
    return CharacterGenerator = (function() {
      ...
      function CharacterGenerator(lc) {
        liquidCrystal = lc;
      }
      ...
      CharacterGenerator.prototype.printSymbol = function(symbol) {
        utils.each(symbol.mask, this, function(bit, key, index) {
          if (bit === 1) {
            return liquidCrystal.setPixel.apply(liquidCrystal, utils.index2coord(symbol.size, index));
          }
        });
        return void 0;
      };
    ...
    return Display = (function() {
      ...
      Display.prototype.setLiquidCrystal = function(lc) {
        if (utils.instanceOf(lc, LiquidCrystal)) {
          liquidCrystal = new lc(this.width, this.height);
      ...
      Display.prototype.printSymbol = function(symbol) {
        if (utils.instanceOf(symbol, Symbol)) {
          ...
          utils.each(symbol.mask, this, function(bit, key, index) {
            if (bit === 1) {
              return setPixel.apply(this, utils.index2coord(symbol.size, index));
            }
          });
        }
        return void 0;
    ...
    return LiquidCrystal = (function() {
      ...
      LiquidCrystal.prototype.mount = function(parent) {
        ...
        el.styles(parent, {
          ...
          height: "" + (((this.pixelSize + 1) * this.height) + 1) + "px",
