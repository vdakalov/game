...
(function() {
  di("LiquidCrystal", ["DefaultPixel", "BasePixel", "utils", "el"], function(DefaultPixel, BasePixel, utils, el) {
...
(function() {
  di("MT16S2H2FLA", ["LiquidCrystal"], function(LiquidCrystal) {
    var MT16S2H2FLA;
...
(function() {
  inject(["el", "utils", "MT16S2H2FLA"], function(el, utils, MT16S2H2FLA) {
    var lc;
