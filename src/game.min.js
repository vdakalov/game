  ...
  service("BasePixel:el", function(el) {
    ...
    return BasePixel = (function() {
      ...
      BasePixel.prototype.active = function(turn) {
        return el.style(this.el, "opacity", turn ? ".9" : ".1");
      };
...
(function() {
  service("DefaultPixel:el,BasePixel", function(el, BasePixel) {
    ...
    return DefaultPixel = (function() {
      ...
      function DefaultPixel(x, y, size) {
        this.x = x;
        this.y = y;
        this.size = size;
        this.make();
...
(function() {
  service("LiquidCrystal:DefaultPixel,BasePixel,utils,el", function(DefaultPixel, BasePixel, utils, el) {
    ...
    return LiquidCrystal = (function() {
      ...
      LiquidCrystal.prototype.pixelSize = 1;

      LiquidCrystal.prototype.backlight = "#FED04B";
      ...
      LiquidCrystal.prototype.init = function(pixel) {
        ...
        if (utils.instanceOf(pixel, BasePixel)) {
          return utils.repeat(this.width * this.height, this, function(index) {
            ...
            return this.push(new pixel(coord[0], coord[1], this.pixelSize));
          });
        }
      };
...
(function() {
  controller("main:el,HexSymbol,Display,MT16S2H2FLA,CloseRenderPreprocessor", function(el, HexSymbol, Display, MT16S2H2FLA, CloseRenderPreprocessor) {
    var display, symbols;
    symbols = {
...
(function() {
  service("MT16S2H2FLA:LiquidCrystal", function(LiquidCrystal) {
    ...
    return MT16S2H2FLA = (function() {
      ...
      MT16S2H2FLA.prototype.pixelSize = 4;
...
(function() {
  service("RenderPreprocessor", function() {
    var RenderPreprocessor;
    return RenderPreprocessor = (function() {
